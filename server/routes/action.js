...
router.post('/', function(req, res, next) {
  ...
  req.on('end', () => {
   ...
   if(json.azione === "aggiungi"){
      //chiamare il db
      functions.aggiungiTodo(json.id,json.titolo, json.descrizione, json.tipoLista,json.data, db, res)
   }
   if(json.azione === "modifica"){
      //chiamare il db
      functions.modificaTodo(json.id,json.titolo, json.descrizione,json.tipoLista,json.data, db, res)
   }
